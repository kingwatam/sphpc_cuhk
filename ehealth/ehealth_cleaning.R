...
df <- foreign_to_labelled(haven::read_sav("EHealthIIEvaluation_DATA_NOHDRS_2021-06-22_1135.sav", encoding = "UTF-8")) # Sys.setlocale(category = "LC_ALL", locale = "cht")
...
temp <- xlsx::read.xlsx2("Raw Data (from Oct 8) and Summary 20210622_duplicates.xlsx", sheetName  = "duplicate record"
                         , encoding = "UTF-8"
                         , header = TRUE
)
