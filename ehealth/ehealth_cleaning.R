...
df <- foreign_to_labelled(haven::read_sav("EHealthIIEvaluation_DATA_NOHDRS_2021-06-29_1115.sav", encoding = "UTF-8")) # Sys.setlocale(category = "LC_ALL", locale = "cht")
...
temp <- xlsx::read.xlsx2("Raw Data (from Oct 8) and Summary 20210628_duplicates.xlsx", sheetName  = "duplicate record"
                         , encoding = "UTF-8"
                         , header = TRUE
)
...
wbs2 <- xlsx::read.xlsx2("EHealth_NEW_DATA_WBS_Complete_SCHSA_2021-06-05.xlsx", sheetName  = "Raw data"
